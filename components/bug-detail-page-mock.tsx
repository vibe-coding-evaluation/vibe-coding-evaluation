...
interface BugDetailPageMockProps {
  bugId?: number
}

export function BugDetailPageMock({ bugId = 338662 }: BugDetailPageMockProps) {
  const { bug, loading, error, updateBug, saving } = useBugDataMock(bugId)
